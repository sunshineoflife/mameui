const i8xc196_device::disasm_entry i8xc196_device::disasm_entries[0x100] = {
...
void i8xc196_device::bmov_direct_2_196_full()
{
	OP1 = read_pc();
	OP2 = read_pc();
}

void i8xc196_device::cmpl_direct_2_196_full()
{
	OP1 = read_pc();
	OP2 = read_pc();
}

void i8xc196_device::bmovi_direct_2_196_full()
{
	OP1 = read_pc();
	OP2 = read_pc();
}

void i8xc196_device::pop_indirect_1_196_full()
{
	OPI = read_pc();
	OP1 = reg_r16(OPI);
	TMP = reg_r16(0x18);
...
void i8xc196_device::pop_indexed_1_196_full()
{
	OPI = read_pc();
	OP1 = read_pc();
	if(OPI & 0x01) {
...
void i8xc196_device::djnzw_rrel8_196_full()
{
	OP2 = read_pc();
	OP1 = int8_t(read_pc());
	TMP = reg_r16(OP2);
...
void i8xc196_device::do_exec_full()
{
	...
	case 0x0cd: bmovi_direct_2_196_full(); break;
	case 0x0ce: pop_indirect_1_196_full(); break;
	case 0x0cf: pop_indexed_1_196_full(); break;
	...
	case 0x0e1: djnzw_rrel8_196_full(); break;
	...
	case 0x1cd: bmovi_direct_2_196_full(); break;
	case 0x1ce: pop_indirect_1_196_full(); break;
	case 0x1cf: pop_indexed_1_196_full(); break;
	...
	case 0x1e1: djnzw_rrel8_196_full(); break;
