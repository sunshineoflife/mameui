 ...
 *
 *  DVT:    MAR¡û L¡û DASTART+1;
 *      CBA¡û L, L¡û 0;
 *      CURDATA¡û L;
 *      SLC¡û L;
 *      T¡û MD;          CAUSE A VERTICAL FIELD INTERRUPT
 *      L¡û NWW OR T;
 *      MAR¡û CURLOC;        SET UP THE CURSOR
 *      NWW¡û L, T¡û 0-1;
 *      L¡û MD XOR T;        HARDWARE EXPECTS X COMPLEMENTED
 *      T¡û MD, EVENFIELD;
 *      CURX¡û L, :DVT1;
 *
 *  DVT1:   L¡û BIAS-T-1, TASK, :DVT2;   BIAS THE Y COORDINATE
 *  DVT11:  L¡û BIAS-T, TASK;
 *
 *  DVT2:   YPOS¡û L, :DVT;
 */
